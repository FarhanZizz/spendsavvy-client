    ...
    <div className="my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 ">
        <div className="w-full mx-auto max-w-sm p-4 border border-gray-200  rounded-lg shadow-md sm:p-8  ">
          <h5 className="mb-4 text-xl font-medium">Basic plan</h5>
        ...
        <div className="w-full mx-auto max-w-sm p-4 border border-gray-200  rounded-lg shadow-md sm:p-8  ">
          <h5 className="mb-4 text-xl font-medium">Plus plan</h5>
          <div className="flex items-baseline ">
            <span className="text-3xl font-semibold">$</span>
        ...
        <div className="w-full mx-auto max-w-sm p-4 border border-gray-200  rounded-lg shadow-md sm:p-8  ">
          <h5 className="mb-4 text-xl font-medium">Premium plan</h5>
          <div className="flex items-baseline ">
            <span className="text-3xl font-semibold">$</span>
